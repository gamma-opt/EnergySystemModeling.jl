...
instance=`sed -n "${n} p" instances_rd1.txt`      # Get n-th line (1-indexed) of the file

srun julia /scratch/work/condeil1/EnergySystemModeling.jl/.triton/exe/opt/run_nodal_clust.jl ${instance} "day" "false"
