...
- `regionset`: Name for the region used.
...
- `instance_name`: Sets the name of the instance for which the data is being generated.
"""
...
# Hydro_capacity.csv file
    ...
    rename!(Hydro, ["node", "hydro_tech", "hcap_min", "hcap_max", "wcap_min" ,"wcap_max"])
...
# hydro.csv file
    ...
    Hydro = DataFrame(hcat(node, HydroRoR, Fmin, hyd_in_avg, hydror_avg, hyd_flow_min), :auto)
