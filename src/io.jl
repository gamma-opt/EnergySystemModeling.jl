...
"""
function Params(DataInput_path::AbstractString, Instances_path_ftr::AbstractString, Instances_path_clust::AbstractString)
    ...
    rep_periods = JSON.parsefile(joinpath(Instances_path_clust, "rep_periods.json"))
    T = 1:rep_periods["T"]
...
function perform_Params(constants_path::AbstractString, Instances_path_ftr::AbstractString, output_path::AbstractString)
    ...
    parameters = Params(constants_path, Instances_path_ftr, Instances_path_clust)
